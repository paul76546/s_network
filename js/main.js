...
allPosts: [
  {
    ...
    text: 'Сегодня вечером после обеда (так всегда в новогодние праздники) я случайно открыл дверку холодильника. Жена как раз мыла посуду и смеясь сказала горькую правду: — "В Новый год мясо в холодильнике всё доели, салаты на Рождество съели, на сына День Рождения — сало с морозилки доедать будем!"',
